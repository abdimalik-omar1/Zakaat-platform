        ...
        <div className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:placeholder-gray-500 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-400"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className="h-10 w-16 rounded-lg border border-gray-200 dark:border-gray-700 cursor-pointer dark:bg-gray-800"
            />
          </div>
